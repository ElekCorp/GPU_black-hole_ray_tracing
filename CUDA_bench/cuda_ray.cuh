...
/*
    ...
    */
    ...
    /*
    ch[0] = (2 * pown(Q, 2) * pown(a, 2) * v[0] * v[1] * x[1] + 2 * pown(Q, 2) * v[0] * v[1] * pown(x[1], 3) + pown(a, 4) * rs * v[0] * v[1] + pown(a, 3) * v[1] * v[3] * (2 * pown(Q, 2) * x[1] + pown(a, 2) * rs - rs * pown(x[1], 2)) * pown(sin(x[2]), 4) - 2 * pown(a, 3) * v[2] * v[3] * (-pown(Q, 2) * (pown(Q, 2) + pown(a, 2)) + rs * pown(x[1], 3) + rs * x[1] * (2 * pown(Q, 2) + pown(a, 2)) - pown(x[1], 2) * (pown(Q, 2) + pown(rs, 2))) * pown(sin(x[2]), 3) * cos(x[2]) + pown(a, 2) * v[0] * v[2] * (-pown(Q, 2) * (pown(Q, 2) + pown(a, 2)) + rs * pown(x[1], 3) + rs * x[1] * (2 * pown(Q, 2) + pown(a, 2)) - pown(x[1], 2) * (pown(Q, 2) + pown(rs, 2))) * sin(2 * x[2]) + a * v[1] * (-4 * pown(Q, 2) * pown(a, 2) * v[3] * x[1] - 4 * pown(Q, 2) * v[3] * pown(x[1], 3) - pown(a, 4) * rs * v[3] - pown(a, 3) * rs * v[0] + a * rs * pown(x[1], 2) * (2 * a * v[3] - v[0]) + 3 * rs * v[3] * pown(x[1], 4)) * pown(sin(x[2]), 2) - rs * v[0] * v[1] * pown(x[1], 4)) / (pown(pown(a, 2) * pown(cos(x[2]), 2) + pown(x[1], 2), 2) * (pown(Q, 2) + pown(a, 2) - rs * x[1] + pown(x[1], 2)));

    ch[1] = (1.0 / 2.0) * (2 * pown(Q, 2) * pown(v[0], 2) * x[1] * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) + pown(a, 4) * pown(v[3], 2) * (-5 * rs * pown(x[1], 4) - rs * pown(x[1], 2) * (6 * pown(Q, 2) + 6 * pown(a, 2) + pown(rs, 2)) - rs * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) + 2 * pown(x[1], 5) + 4 * pown(x[1], 3) * (pown(Q, 2) + pown(a, 2) + pown(rs, 2)) + 2 * x[1] * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4) + pown(rs, 2) * (pown(Q, 2) + pown(a, 2)))) * pown(sin(x[2]), 6) + pown(a, 4) * (-pown(a, 2) * rs * pown(v[1], 2) - 4 * rs * pown(v[2], 2) * pown(x[1], 4) + rs * pown(x[1], 2) * (pown(v[1], 2) - 4 * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2))) + 2 * pown(v[2], 2) * pown(x[1], 5) + 2 * pown(v[2], 2) * pown(x[1], 3) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2)) - 2 * x[1] * (pown(Q, 2) * pown(v[1], 2) - pown(v[2], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)))) * pown(cos(x[2]), 4) - 1.0 / 2.0 * pown(a, 2) * v[1] * v[2] * pown(pown(a, 2) * cos(2 * x[2]) + pown(a, 2) + 2 * pown(x[1], 2), 2) * (-pown(Q, 2) - pown(a, 2) + rs * x[1] - pown(x[1], 2)) * sin(2 * x[2]) + pown(a, 2) * pown(v[3], 2) * (pown(a, 2) * rs * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) + 7 * rs * pown(x[1], 6) + rs * pown(x[1], 4) * (2 * pown(Q, 2) + 15 * pown(a, 2) - pown(rs, 2)) + rs * pown(x[1], 2) * (-5 * pown(Q, 4) + 4 * pown(Q, 2) * pown(a, 2) + 9 * pown(a, 4) + pown(a, 2) * pown(rs, 2)) - 4 * pown(x[1], 7) - 2 * pown(x[1], 5) * (3 * pown(Q, 2) + 6 * pown(a, 2) + pown(rs, 2)) + 4 * pown(x[1], 3) * (-3 * pown(Q, 2) * pown(a, 2) - 3 * pown(a, 4) + pown(rs, 2) * (pown(Q, 2) - pown(a, 2))) - 2 * x[1] * (-pown(Q, 6) + 3 * pown(Q, 2) * pown(a, 4) + 2 * pown(a, 6) + pown(a, 2) * pown(rs, 2) * (pown(Q, 2) + pown(a, 2)))) * pown(sin(x[2]), 4) + pown(a, 2) * (-2 * pown(rs, 2) * pown(v[0], 2) * x[1] * (pown(Q, 2) + pown(a, 2)) + rs * pown(v[0], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) - 8 * rs * pown(v[2], 2) * pown(x[1], 6) + rs * pown(x[1], 4) * (pown(v[0], 2) + 2 * pown(v[1], 2) - 8 * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2))) + rs * pown(x[1], 2) * (-2 * pown(a, 2) * pown(v[1], 2) + pown(v[0], 2) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2))) + 4 * pown(v[2], 2) * pown(x[1], 7) + 4 * pown(v[2], 2) * pown(x[1], 5) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2)) + 2 * pown(x[1], 3) * (-2 * pown(Q, 2) * pown(v[1], 2) - pown(rs, 2) * pown(v[0], 2) + 2 * pown(v[2], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)))) * pown(cos(x[2]), 2) - rs * pown(v[0], 2) * pown(x[1], 2) * (5 * pown(Q, 4) + 6 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) - 4 * rs * pown(v[2], 2) * pown(x[1], 8) + rs * pown(x[1], 6) * (-pown(v[0], 2) + pown(v[1], 2) - 4 * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2))) - rs * pown(x[1], 4) * (pown(a, 2) * pown(v[1], 2) + pown(v[0], 2) * (6 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2))) + 2 * pown(v[0], 2) * pown(x[1], 3) * (2 * pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(rs, 2) * (2 * pown(Q, 2) + pown(a, 2))) + 2 * pown(v[2], 2) * pown(x[1], 9) + 2 * pown(v[2], 2) * pown(x[1], 7) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2)) + 2 * pown(x[1], 5) * (-pown(Q, 2) * pown(v[1], 2) + pown(v[0], 2) * (pown(Q, 2) + pown(rs, 2)) + pown(v[2], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4))) + (pown(a, 6) * pown(v[1], 2) * (rs - 2 * x[1]) * pown(cos(x[2]), 4) + 2 * pown(a, 3) * (2 * pown(rs, 2) * v[0] * v[3] * x[1] * (pown(Q, 2) + pown(a, 2)) - rs * v[0] * v[3] * pown(x[1], 4) - rs * v[0] * v[3] * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) + rs * pown(x[1], 2) * (a * pown(v[1], 2) - v[0] * v[3] * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2))) + 2 * pown(x[1], 3) * (-a * pown(v[1], 2) + pown(rs, 2) * v[0] * v[3])) * pown(cos(x[2]), 2) + 2 * a * rs * v[3] * pown(x[1], 2) * (-2 * pown(a, 3) * v[3] * (pown(Q, 2) + pown(a, 2)) + v[0] * (5 * pown(Q, 4) + 6 * pown(Q, 2) * pown(a, 2) + pown(a, 4))) + a * rs * pown(x[1], 4) * (a * pown(v[1], 2) - 4 * a * pown(v[3], 2) * (2 * pown(Q, 2) + 3 * pown(a, 2)) + 2 * v[0] * v[3] * (6 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2))) + 2 * a * v[3] * pown(x[1], 3) * (a * v[3] * (2 * pown(Q, 4) + 6 * pown(Q, 2) * pown(a, 2) + 4 * pown(a, 4) + pown(a, 2) * pown(rs, 2)) - 2 * v[0] * (2 * pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(rs, 2) * (2 * pown(Q, 2) + pown(a, 2)))) - 2 * a * v[3] * x[1] * (2 * pown(Q, 2) * v[0] - pown(a, 3) * v[3]) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) - 4 * rs * pown(v[3], 2) * pown(x[1], 8) + 2 * rs * v[3] * pown(x[1], 6) * (a * v[0] - 2 * v[3] * (pown(Q, 2) + 3 * pown(a, 2))) + 2 * pown(v[3], 2) * pown(x[1], 9) + 2 * pown(v[3], 2) * pown(x[1], 7) * (2 * pown(Q, 2) + 4 * pown(a, 2) + pown(rs, 2)) + 2 * pown(x[1], 5) * (-pown(a, 2) * pown(v[1], 2) - 2 * a * v[0] * v[3] * (pown(Q, 2) + pown(rs, 2)) + pown(v[3], 2) * (pown(Q, 4) + 6 * pown(Q, 2) * pown(a, 2) + 6 * pown(a, 4) + 2 * pown(a, 2) * pown(rs, 2)))) * pown(sin(x[2]), 2)) / (pown(pown(a, 2) * pown(cos(x[2]), 2) + pown(x[1], 2), 3) * (pown(Q, 2) + pown(a, 2) - rs * x[1] + pown(x[1], 2)));

    ch[2] = (2 * pown(a, 4) * v[1] * v[2] * x[1] * (-pown(Q, 2) - pown(a, 2) + rs * x[1] - pown(x[1], 2)) * pown(cos(x[2]), 4) + 4 * pown(a, 2) * v[1] * v[2] * pown(x[1], 3) * (-pown(Q, 2) - pown(a, 2) + rs * x[1] - pown(x[1], 2)) * pown(cos(x[2]), 2) + 2 * rs * v[1] * v[2] * pown(x[1], 6) - 2 * v[1] * v[2] * pown(x[1], 7) - 2 * v[1] * v[2] * pown(x[1], 5) * (pown(Q, 2) + pown(a, 2)) - (pown(Q, 2) * pown(a, 4) * pown(v[3], 2) * (pown(Q, 2) + pown(a, 2)) - 2 * pown(Q, 2) * pown(a, 3) * v[0] * v[3] * (pown(Q, 2) + pown(a, 2)) + pown(Q, 2) * pown(a, 2) * pown(v[0], 2) * (pown(Q, 2) + pown(a, 2)) + pown(a, 4) * (pown(a, 2) * pown(v[1], 2) - pown(a, 2) * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2)) + 2 * rs * pown(v[3], 2) * pown(x[1], 3) + rs * x[1] * (pown(a, 2) * pown(v[2], 2) + 2 * pown(v[3], 2) * (pown(Q, 2) + pown(a, 2))) - pown(v[3], 2) * pown(x[1], 4) - pown(v[3], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) - pown(x[1], 2) * (pown(a, 2) * pown(v[2], 2) + pown(v[3], 2) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2)))) * pown(cos(x[2]), 4) - pown(a, 2) * rs * x[1] * (2 * pown(Q, 2) + pown(a, 2)) * (pown(a, 2) * pown(v[3], 2) - 2 * a * v[0] * v[3] + pown(v[0], 2)) + 2 * pown(a, 2) * pown(x[1], 2) * (pown(a, 2) * pown(v[1], 2) - pown(a, 2) * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2)) + 2 * rs * pown(v[3], 2) * pown(x[1], 3) + rs * x[1] * (pown(a, 2) * pown(v[2], 2) + 2 * pown(v[3], 2) * (pown(Q, 2) + pown(a, 2))) - pown(v[3], 2) * pown(x[1], 4) - pown(v[3], 2) * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 4)) - pown(x[1], 2) * (pown(a, 2) * pown(v[2], 2) + pown(v[3], 2) * (2 * pown(Q, 2) + 2 * pown(a, 2) + pown(rs, 2)))) * pown(cos(x[2]), 2) + a * rs * pown(x[1], 5) * (a * pown(v[2], 2) - a * pown(v[3], 2) + 2 * v[0] * v[3]) + a * rs * pown(x[1], 3) * (-a * pown(v[0], 2) - a * pown(v[3], 2) * (4 * pown(Q, 2) + 3 * pown(a, 2)) + 4 * v[0] * v[3] * (pown(Q, 2) + pown(a, 2))) + a * pown(x[1], 4) * (a * pown(v[1], 2) - a * pown(v[2], 2) * (pown(Q, 2) + pown(a, 2)) + a * pown(v[3], 2) * (pown(Q, 2) - pown(a, 2) + 2 * pown(rs, 2)) - 2 * v[0] * v[3] * (pown(Q, 2) + pown(rs, 2))) + a * pown(x[1], 2) * (a * pown(v[0], 2) * (pown(Q, 2) + pown(rs, 2)) + a * pown(v[3], 2) * (2 * pown(Q, 4) + 3 * pown(Q, 2) * pown(a, 2) + pown(a, 2) * pown(rs, 2)) - 2 * v[0] * v[3] * (pown(Q, 4) + 2 * pown(Q, 2) * pown(a, 2) + pown(a, 2) * pown(rs, 2))) + rs * pown(v[3], 2) * pown(x[1], 7) - pown(v[3], 2) * pown(x[1], 8) - pown(x[1], 6) * (pown(a, 2) * pown(v[2], 2) + pown(v[3], 2) * (pown(Q, 2) + 2 * pown(a, 2)))) * sin(x[2]) * cos(x[2])) / (pown(pown(a, 2) * pown(cos(x[2]), 2) + pown(x[1], 2), 3) * (pown(Q, 2) + pown(a, 2) - rs * x[1] + pown(x[1], 2)));

    ch[3] = (-2 * pown(a, 4) * v[2] * v[3] * (pown(Q, 2) + pown(a, 2) - rs * x[1] + pown(x[1], 2)) * pown(sin(x[2]), 4) * cos(x[2]) + 2 * pown(a, 2) * v[2] * v[3] * (pown(Q, 4) + 3 * pown(Q, 2) * pown(a, 2) + 2 * pown(a, 4) - 3 * rs * pown(x[1], 3) - rs * x[1] * (2 * pown(Q, 2) + 3 * pown(a, 2)) + 2 * pown(x[1], 4) + pown(x[1], 2) * (3 * pown(Q, 2) + 4 * pown(a, 2) + pown(rs, 2))) * pown(sin(x[2]), 2) * cos(x[2]) - v[1] * (2 * pown(Q, 2) * a * x[1] * (a * v[3] - v[0]) + 2 * pown(Q, 2) * v[3] * pown(x[1], 3) + pown(a, 4) * v[3] * (-rs + 2 * x[1]) * pown(cos(x[2]), 4) + pown(a, 2) * (pown(a, 2) * rs * v[3] - a * rs * v[0] - rs * v[3] * pown(x[1], 2) + 4 * v[3] * pown(x[1], 3)) * pown(cos(x[2]), 2) + a * rs * pown(x[1], 2) * (-a * v[3] + v[0]) - 2 * rs * v[3] * pown(x[1], 4) + 2 * v[3] * pown(x[1], 5)) * sin(x[2]) - 2 * v[2] * (pown(Q, 2) * a * v[0] * (pown(Q, 2) + pown(a, 2)) + pown(a, 4) * v[3] * (pown(Q, 2) + pown(a, 2)) - a * rs * pown(x[1], 3) * (2 * a * v[3] + v[0]) - a * rs * x[1] * (pown(a, 3) * v[3] + v[0] * (2 * pown(Q, 2) + pown(a, 2))) + a * pown(x[1], 2) * (a * v[3] * (2 * pown(Q, 2) + 3 * pown(a, 2)) + v[0] * (pown(Q, 2) + pown(rs, 2))) - rs * v[3] * pown(x[1], 5) + v[3] * pown(x[1], 6) + v[3] * pown(x[1], 4) * (pown(Q, 2) + 3 * pown(a, 2))) * cos(x[2])) / (pown(pown(a, 2) * pown(cos(x[2]), 2) + pown(x[1], 2), 2) * (pown(Q, 2) + pown(a, 2) - rs * x[1] + pown(x[1], 2)) * sin(x[2]));
    */
