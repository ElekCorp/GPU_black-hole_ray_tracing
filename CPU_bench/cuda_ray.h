...
template <class FP>
inline FP ijk_to_vec_mink_zoom(int i, int j, int k, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg, kerr_black_hole<FP>& hole);
template <class FP>
inline FP ijk_to_vec_zoom(int i, int j, int k, kerr_black_hole<FP>& hole, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg);
...
template <class FP>
inline void ray_step(int8_t* szin, int SZELES, int MAGAS, FP* x, FP* Omega, FP a, FP Q, FP rs, FP errormax, FP de0, FP kepernyo_high, FP kepernyo_tav, FP sugar_ki, FP gyuru_sugar_kicsi, FP gyuru_sugar_nagy, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg);
template <class FP>
inline void ray_step_T(FP* szin, int SZELES, int MAGAS, FP* x, FP* Omega, FP a, FP Q, FP rs, FP errormax, FP de0, FP kepernyo_high, FP kepernyo_tav, FP sugar_ki, FP gyuru_sugar_kicsi, FP gyuru_sugar_nagy, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg);
...
template <class FP>
inline void ray_step(int8_t* szin, int SZELES, int MAGAS, FP* xd, FP* Omega, FP a, FP Q, FP rs, FP errormax, FP de0, FP kepernyo_high, FP kepernyo_tav, FP sugar_ki, FP gyuru_sugar_kicsi, FP gyuru_sugar_nagy, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg)//kernel
{
...
template <class FP>
inline void ray_step_T(FP* szin, int SZELES, int MAGAS, FP* xd, FP* Omega, FP a, FP Q, FP rs, FP errormax, FP de0, FP kepernyo_high, FP kepernyo_tav, FP sugar_ki, FP gyuru_sugar_kicsi, FP gyuru_sugar_nagy, int SZELESregi, int MAGASregi, int ikezd, int jkezd, int iveg)//kernel
{
