...
for num in range(num_of_frames):
    filename="kep_double.dat"#"data"+str(num//100)+str((num%100)//10)+str((num%100)%10)+".dat"#_double
    print(filename)
    ...
    nevex="C:\\Users\\elekp\\source\\repos\\kerr_class_szines_kep\\kerr_class_szines_kep\\kepekx\\blackholle"+now.strftime("%m_%d_%Y_%H_%M_%S")+"__"+str(num)
    img.save(nevex+".png")
        
print(xmax)
#img.show()
neve="C:\\Users\\elekp\\source\\repos\\kerr_class_szines_kep\\kerr_class_szines_kep\\kepekx\\blackholle"+now.strftime("%m_%d_%Y_%H_%M_%S")
